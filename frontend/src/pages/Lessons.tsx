...
export const Lessons = () => {
  ...
  const [createForm, setCreateForm] = useState({ title: '', contentPercent: 0 });
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    setCreateForm({ title: '', contentPercent: 0 });
    loadLessons();
  };
          ...
          <div className="mx-auto max-w-4xl px-4 py-4 sm:px-6">
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-gray-500 text-sm">{data.lessons.length} cours</p>
              </div>
              <button
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full"
              />
              <ProgressBar value={createForm.contentPercent} color={data.subject.color} showLabel={false} />
            </div>
